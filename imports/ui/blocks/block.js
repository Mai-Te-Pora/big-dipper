    ...
    render() {
        ...
        if (proposer){
            ...
            return <Row className="block-info">
                ...
                <Col xs={{size:8, offset:8}} sm={{size:2, offset:0}}><i className="fas fa-database d-sm-none"></i> <Link to={"/blocks/"+this.props.block.height}>#{numbro(this.props.block.height).format('0,0')}</Link></Col>
            </Row>
        }
        else{
