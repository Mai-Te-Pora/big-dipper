...
import { coinList } from "../../../both/utils/coins.js";
...
MultiSend = (props) => {
  return (
    <div>
      <p>
        <T>activities.single</T> <MsgType type={props.msg.type} /> <T>activities.happened</T>
      </p>
      <p>
  ...
  render() {
    ...
    switch (msg.type) {
      ...
      case "cosmos-sdk/MsgSend":
        ...
        return (
          <p>
            ...
            <MsgType type={msg.type} /> <span className="text-success">{amount}</span>{" "}
            <T>activities.to</T>{" "}
      ...
      case "cosmos-sdk/MsgCreateValidator":
        return (
          <p>
            ...
            <T>activities.withMoniker</T> <Link to="#">{msg.value.description.moniker}</Link>
            <T>common.fullStop</T>
          </p>
        );
        ...
        return (
          <p>
            ...
            <span className="text-warning">
              {new Coin(msg.value.amount.amount, msg.value.amount.denom).toString(8)}
            </span>{" "}
            <T>activities.to</T> <Account address={msg.value.validator_address} />
            <T>common.fullStop</T>
          </p>
        );
      case "cosmos-sdk/MsgUndelegate":
        return (
          <p>
            ...
            <T>activities.from</T> <Account address={msg.value.validator_address} />
            <T>common.fullStop</T>
          </p>
        );
      case "cosmos-sdk/MsgBeginRedelegate":
        return (
          <p>
            ...
            <T>activities.from</T> <Account address={msg.value.validator_src_address} />{" "}
            <T>activities.to</T> <Account address={msg.value.validator_dst_address} />
            <T>common.fullStop</T>
          </p>
        );
        ...
        return (
          <p>
            ...
            <em className="text-info">
              {msg.value.amount
                .map((amount, i) => new Coin(amount.amount, amount.denom).toString(8))
                .join(", ")}
            </em>{" "}
            <T>activities.to</T>{" "}
      ...
      case "cosmos-sdk/MsgVote":
        return (
          <p>
            ...
            <T>activities.withA</T> <em className="text-info">{msg.value.option}</em>
            <T>common.fullStop</T>
          </p>
        );
      ...
      case "cosmos-sdk/MsgWithdrawValidatorCommission":
        ...
        let commissionsRows = null;

        if (
          events["withdraw_commission"] &&
          events["withdraw_commission"][0] &&
          events["withdraw_commission"][0].value
        ) {
          ...
          commissionsRows = (
            <p>
              {valueAmountsArr.map((valueAmount, i) => {
                const displayNameOrDenom = valueAmount.match(/[a-zA-Z]+/g)[0]?.toLowerCase();
                const denom = coinList.find(
                  (x) =>
                    x.displayName.toLowerCase() === displayNameOrDenom ||
                    x.denom.toLowerCase() === displayNameOrDenom,
                )?.denom;
                const amount = parseInt(valueAmount);
                const coin = new Coin(amount, denom);
                ...
                return (
                  <>
                    ...
                    {!this.props.invalid && (
                      <T _purify={false} amount={coin.toStringPool(8)}>
                        activities.ofAmount
                      </T>
                    )}

                    {i + 1 == valueAmountsArr.length && (
                      <>
                        {" "}
                        <T>activities.from</T> <Account address={msg.value.validator_address} />
                        <T>common.fullStop</T>
      ...
      case "cosmos-sdk/MsgWithdrawDelegationReward":
        let rewardsRows = null;

        if (
          events["withdraw_rewards"] &&
          events["withdraw_rewards"][0] &&
          events["withdraw_rewards"][0].value
        ) {
      ...
      case "coin/MsgWithdraw":
        return (
          <p>
            <Account address={msg.value.originator} />{" "}
            {this.props.invalid ? <T>activities.failedTo</T> : ""}
            <MsgType type={msg.type} />
            <T>
              {" "}
              {!this.props.invalid
                ? `${msg.value.amount} ${msg.value.denom.toString().toUpperCase()}`
                : ""}
              common.fullStop
            </T>
          </p>
      ...
      case "profile/MsgUpdateProfile":
        return (
          <p>
            ...
            <T>
              {" "}
              {!this.props.invalid ? `with a username of ${msg.value.username}` : ""}
              common.fullStop
            </T>
          </p>
        );
        ...
        return (
          <p>
            ...
            <T>
              ...
              {!this.props.invalid ? (
                <Order
                  address={msg.value.originator}
                  market={msg.value.market.toString().toUpperCase()}
        ...
        return (
          <p>
            ...
            <T>
              {" "}
              {!this.props.invalid ? (
                <Pool address={msg.value.originator} pool={msg.value.pool_id} type="1" />
              ) : (
                ""
              )}
              common.fullStop
          ...
          <p>
            ...
            <T>
              ...
              {!this.props.invalid ? (
                <Pool
                  address={msg.value.originator}
                  pool={msg.value.pool_id}
                  shares={msg.value.shares}
                  type="2"
                />
              ) : (
                ""
            ...
            <T>
              ...
              {!this.props.invalid ? (
                <Pool
                  address={msg.value.originator}
                  pool={msg.value.pool_id}
                  shares={msg.value.min_shares}
                  amountA={msg.value.amount_a}
                  amountB={msg.value.amount_b}
                  type="3"
                />
              ) : (
                ""
            ...
            <T>
              ...
              {!this.props.invalid ? (
                <Pool
                  ...
                  denom={msg.value.denom.toString().toUpperCase()}
                  type="4"
                />
              ) : (
                ""
        ...
        return (
          <p>
            ...
            <T>
              {" "}
              {!this.props.invalid
                ? `for ${msg.value.oracle_id} with a price of $${msg.value.data}`
                : ""}
              common.fullStop
            </T>
          </p>
