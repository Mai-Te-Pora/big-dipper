    ...
    render() {
        ...
        return (
            <Navbar color="primary" dark expand="lg" fixed="top" id="header">
                <NavbarBrand tag={Link} to="/"><img src="/img/favicon-32x32.png" className="img-fluid logo"/> <span className="d-none d-xl-inline-block"><T>navbar.siteName</T>&nbsp;</span><Badge color="secondary"><T>navbar.version</T></Badge> </NavbarBrand>
                        ...
                        {/*<NavItem>
                            <UncontrolledDropdown inNavbar>
                                ...
                                <DropdownMenu right>
                                    ...
                                    <DropdownItem onClick={(e) => this.handleLanguageSwitch('fr-FR', e)}><T>navbar.french</T></DropdownItem>
