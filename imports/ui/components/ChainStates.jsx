        ...
        return <Card className="d-lg-inline-block">
            <CardHeader>
                <Row className="text-nowrap">
                    <Col xs={4} md="auto"><small><span><T>chainStates.price</T>:</span> <strong>${(this.state.price).toFixed(4)}</strong></small></Col>
                    <Col xs={8} md="auto"><small><span><T>chainStates.marketCap</T>:</span> <strong>{Math.round(this.state.marketCap)}</strong></small></Col>
