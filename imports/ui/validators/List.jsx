...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <SentryBoundary><Row className="validator-info">
            ...
            <Col className="self-delegation data" xs={{size:4,offset:2}} md={{size:1,offset:0}}><i className="material-icons d-sm-none">equalizer</i> <span>{props.validator.self_delegation?numbro(Math.round(props.validator.self_delegation*props.validator.voting_power)).format('0,0'):'N/A'}</span></Col>
