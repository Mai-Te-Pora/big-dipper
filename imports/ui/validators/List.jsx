...
const ValidatorRow = (props) => {
    ...
    return <Card body>
        <SentryBoundary><Row className="validator-info">
            ...
            <Col className="self-delegation data" xs={{size:6,offset:0}} md={{size:1,offset:2}}><i className="material-icons d-sm-none">equalizer</i> <span>{props.validator.self_delegation?numbro(Math.round(props.validator.self_delegation*props.validator.voting_power/100)).format('0,0'):'N/A'} SWTH</span></Col>
