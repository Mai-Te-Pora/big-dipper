...
export default class Validators extends Component{
    ...
    render() {
        ...
        return <div id="validator-list">
            <Helmet>
                <title>TradeHub Validator List</title>
                ...
                <Col md={12}>
                    <Card body>
                        <Row className="header text-nowrap">
                            ...
                            <Col className="voting-power" md={3} lg={2}><i className="material-icons">power</i> <span className="d-inline-block d-md-none d-lg-inline-block"><T>common.votingPower</T></span></Col>
